...
Dalam pembuatan Twitter bot, penulis memanfaatkan KIRI API dan Twitter API. KIRI API digunakan untuk memberi jalur transportasi publik, sedangkan Twitter API digunakan untuk menangkap \textit{tweet} dan membalas \textit{tweet}. Twitter bot yang akan dibangun pada penelitian ini menggunakan bahasa Java dan menggunakan library dari Twitter4J.
